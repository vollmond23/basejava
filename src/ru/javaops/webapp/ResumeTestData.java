...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        newResume.addSection(SectionType.ACHIEVEMENT, new ListSection(achievement));
        ...
        newResume.addSection(SectionType.QUALIFICATIONS, new ListSection(qualifications));

        List<Organization> jobs = new ArrayList<>();
        jobs.add(new Organization("Java Online Projects", "http://javaops.ru/", DateUtil.of(2013, Month.OCTOBER), null, "Автор проекта.", "Создание, организация и проведение Java онлайн проектов и стажировок."));
        ...
        newResume.addSection(SectionType.EXPERIENCE, new OrganizationSection(jobs));
        ...
        spbNIUITMO.addPeriod(DateUtil.of(1993, Month.SEPTEMBER), DateUtil.of(1996, Month.JULY), "Аспирантура (программист С, С++)", null);
        educations.add(spbNIUITMO);
        newResume.addSection(SectionType.EDUCATION, new OrganizationSection(educations));
